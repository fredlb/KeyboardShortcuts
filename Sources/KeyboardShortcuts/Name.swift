extension KeyboardShortcuts {
	...
	*/
	public struct Name: Hashable {
		...
		*/
        public init(_ name: String, customStorageProvider: StorageProvider? = nil, default initialShortcut: Shortcut? = nil) {
			self.rawValue = name
			self.defaultShortcut = initialShortcut
            
            KeyboardShortcuts.initialize(customStorage: customStorageProvider)
		}
	}
}
